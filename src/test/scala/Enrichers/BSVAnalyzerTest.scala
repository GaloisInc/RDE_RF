...
class BSVAnalyzerTest extends AnyFlatSpec with should.Matchers {
  ...
  "BSVDocumentEnricher" should "be able to extract modules from Actuation" in {
    ...
    TestUtilityBSV.checkExtractReferences(fileName, documentAnalyser, expectedDocumentType, numberExpectedSystem = 1)
  }
  ...
  "BSVDocumentEnricher" should "be able to extract modules from Actuation_Generated_BVI" in {
    ...
    TestUtilityBSV.checkExtractReferences(fileName, documentAnalyser, expectedDocumentType, numberExpectedSystem = 1, numberOfSubSystem = 3)
  }
  ...
  "BSVDocumentEnricher" should "be able to extract modules from Nerv_BVI" in {
    ...
    TestUtilityBSV.checkExtractReferences(fileName, documentAnalyser, expectedDocumentType, numberExpectedSystem = 1, numberOfSubSystem = 1)
  }
